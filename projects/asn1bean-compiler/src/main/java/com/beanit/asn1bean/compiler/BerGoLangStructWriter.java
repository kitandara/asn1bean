...
public class BerGoLangStructWriter extends BerJavaClassWriter implements BerImplementationWriter {
  ...
  protected void writeClassHeader(String typeName, AsnModule module) throws IOException {
    ...
    write("/*");
    write(
        " * This class file was automatically generated by ASN1bean fork "
            + versionString
            + " (https://github.com/kitandara/asn1bean -- libs at https://github.com/kitandara/asn1ber )\n */\n");
    ...
    write("// Suppress warnings about unused modules!");
    write("var (\n"
        + "\t_ = io.Discard\n"
        + "\t_ = fmt.Sprint\n"
        + "\t_ = hex.Decode\n"
  ...
  protected void writeChoiceDecodeMethod(String className, List<ComponentInfo> components, boolean hasExplicitTag)
    ...
    write(
        "return 0,errors.New(fmt.Sprintf(\"Error decoding CHOICE: Tag %s matched to no item\",berTag.S()))");
  ...
  protected void writeSetDecodeFunction(String className, List<ComponentInfo> components, boolean hasExplicitTag)
    ...
    write("} else {");
    write("return 0,  errors.New(fmt.Sprintf(\"tag does not match any set component: %s\", berTag.S()))");
    write("}");
